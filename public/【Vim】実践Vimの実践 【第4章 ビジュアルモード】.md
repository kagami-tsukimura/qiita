...
tags:
  ...
  - 新人プログラマ応援
private: false
updated_at: '2023-06-12T08:47:21+09:00'
...
2023年6月12日現在、`Kindle Unlimited`対象商品です。
...
>ビジュアルモードには3つのサブモードがあるが、これらはそれぞれ異なる種類のテキストを扱う。
(実践Vim「TIP21」より)
...
- `ビジュアルモード`でインデントする。[^1]
    [^1]: 本書の`fibonacci-malformed.py`はPython2系の記述だったため、Python3系の記述に書き換えています。
...
>Vimのノーマルモードでの操作と比べて、ビジュアルモードのほうが直感的かもしれないが、これには弱点がある。
...
- リンクを大文字に変換する。
    ...
    - `j.j.`で残りの行も大文字変換を試みる。
        ...
        - 元々のコマンドが3文字に適用したため、3文字しか繰り返されない。
     ```text: chapter_code/4_visual/visual_mode/list-of-links.html
    <a href="#">ONE</a>
    <a href="#">TWO</a>
    <a href="#">THRee</a>
...
- 長さの異なる各行の末尾にセミコロン(;)を追加する。[^3]
    [^3]: ドットコマンド(.)で対処する場合は[第1章](https://qiita.com/kagami_t/items/623a56f52d10660f72ec "第1章")を参照。
...
知らなくてもエディタとして最低限の役割を果たせますし、`ビジュアル`でも3種類に分かれています。
